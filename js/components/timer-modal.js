...
export function showTimerModal({ habit, streak, memberId, onComplete }) {
  ...
  overlay.innerHTML = `
    <div class="timer-sheet" style="background:rgba(10,10,25,0.45);backdrop-filter:blur(14px) saturate(1.8);-webkit-backdrop-filter:blur(14px) saturate(1.8);border-top:1px solid rgba(255,255,255,0.1);box-shadow:0 -4px 20px rgba(0,0,0,0.3)">
